...
const repo = "nao-matsunami/svg-css-vj-pages";
const excluded = new Set([".git", "node_modules", "pages-work"]);
...
async function main() {
  ...
  await run("git", ["commit", "-m", `Publish SVG CSS VJ site ${stamp}`], targetDir);
